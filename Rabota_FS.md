...
Командой `vagrant destroy` удаляем имеющуюся виртуальную машину. На основе предложенной конфигурации создадию новую виртуальную машину (Ubuntu 20.04, 2 CPU, 2 ГБ ОЗУ, 2 диска по 2.5 Гб.
